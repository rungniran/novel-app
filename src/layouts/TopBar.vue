  ...
  <div id="Topbar">
    <div class="topbar">
      <div class="logo">
        <div class="menu-mobile">
          <i class="fas fa-bars menumobile" @click="openLeftmenu()"></i>
        </div>
      ...
      <div
        class="profile-contai-modal"
        @click="profile_onmouse == false ? closemenu() : null"
      >
        <div
          style="
            position: relative;
    ...
    <div class="leftmenu list-sub-menu" id="leftmenu">
      <router-link
        ...
        active-class="active-submenu"
        @click.native="closeLeftmenu()"
        to="/"
        exact
        ><i class="fas fa-home"></i> หน้าหลัก</router-link
      >
      <router-link
        class="list-sub-menu-mobile"
        active-class="active-submenu"
        ...
        to="/category"
        exact
        ><i class="fas fa-list-alt"></i> ประเภท</router-link
      >
      <router-link
        class="list-sub-menu-mobile"
        active-class="active-submenu"
        ...
        to="/bookshelf"
        exact
        ><i class="fas fa-book"></i> ชั้นหนังสือ</router-link
      >
      <router-link
        class="list-sub-menu-mobile"
        active-class="active-submenu"
        ...
        to="/writer"
        exact
        ><i class="fa fa-pencil"></i> นักเขียน</router-link
      >
    </div>
  </div>
</template>
...
export default Vue.extend({
  ...
  mounted() {
    ...
    document.addEventListener("click", (event: any) => {
      if (!event.target.matches(".menumobile")) {
        var dropdowns = document.getElementsByClassName("leftmenu");
        var i = 0;
        for (i; i < dropdowns.length; i++) {
          var openDropdown = dropdowns[i];
          if (openDropdown.classList.contains("leftmenu-show")) {
            openDropdown.classList.remove("leftmenu-show");
          }
        }
      }
    });
...
function api(api: any) { throw new Error('Function not implemented.'); }
function api(api: any) { throw new Error('Function not implemented.'); }
