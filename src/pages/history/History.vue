  ...
  <div class="history">
    <div class="nv-box-white nv-mt-40">
      ...
      <div class="tap-writer">
        <router-link
          @click.native="changeComponent('HistoryRead')"
          to="#HistoryRead"
          :class="
            current === 'HistoryRead' ? 'nv-s nv-s1 nv-s-active' : 'nv-s nv-s1'
          "
        >
          ประวัติการอ่าน
        </router-link>
        <router-link
          @click.native="changeComponent('HistoryBuy')"
          to="#HistoryBuy"
          :class="
            current === 'HistoryBuy' ? 'nv-s nv-s2 nv-s-active' : 'nv-s nv-s2'
          "
        >
          ประวัติการซื้อ
        </router-link>
      </div>
      <div class="nv-mt-30 bg-color-buy">
