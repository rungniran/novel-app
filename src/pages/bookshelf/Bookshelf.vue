    ...
    <div class="nv-box-white nv-mt-40">
      <div class="bookshelf" v-if="bookshelf.length !== 0">
        ...
        <div v-for="(item, index) in bookshelf" :key="index" class="item">
          ...
          <div class="detail">
            <router-link :to="'/novel/' + index" class="name line-1">{{
              item.title
            }}</router-link>
            <div class="flex-s">
      ...
      <div v-else>ไม่มีหนังสือ</div>
    </div>
    <NovelModal
      classlist="Bookshelf-confirm"
      animation="Bookshelf-confirm-amination"
    >
