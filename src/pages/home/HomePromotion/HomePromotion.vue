    ...
    >
        ...
        >
          <div class="box-mywork">
            <NovelImage :image="items.novel_data.image_data.url" :alt="items.novel_data.title "></NovelImage>
           
            <NovelPomotion :cleckP='items.novel_data.novel_promotion_datas.length ' @cleckandP="0" msmP="Sale" msmE='จบ' :cleckE='items.novel_data.status_end_novel'/>
          </div>

          <div class="grod-detail">
            <div class="name line-1">{{ items.novel_data.title }}</div>
            <div class="subname line-1">{{ items.novel_data.novel_category_data_preview }}</div>
            <div>
              <NovelStar
                v-if="star === true"
                :rating="Math.round(items.novel_data.avg_star)"
              />
            </div>
            <div class="view-list">
              <div class="view">
